...
const userStatus = ref<{ exists: boolean; isdeleted: boolean; is_banned: boolean } | null>(null)
...
const loadUser = async () => {
  try {
    ...
    userStatus.value = { exists: status.exists, isdeleted: !!status.isdeleted, is_banned: !!status.is_banned }
    if (!status.exists) {
